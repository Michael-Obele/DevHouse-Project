  ...
  return (
    <section
      ...
      <div className='flex flex-col justify-center items-center pt-[80px] lg:block lg:absolute lg:top-[5rem] left-5 lg:left-[3.467vw]'>
        ...
        <div className='bg-[#1ed760] rounded-l-[4px] rounded-r-[4px] border-x-[2px] border-l-[#0e173c] border-r-[#0e173c] mb-[120px] lg:mb-0 lg:border-r-0 border-y-0 box-border h-fit w-[75vw] md:w-[524px] border-4 flex flex-col lg:relative lg:left-[125px]'>
        ...
        <Image
          className={`${fade.fadeIn} w-[135.84px] h-[256px] mb-[70px] lg:w-[364px] lg:h-[686px] lg:relative lg:bottom-[420px] lg:left-[61vw] xl:left-[52vw] z-[4]`}
        />
        {isLoading ? (
