      ...
      <div className='container justify-center flex flex-wrap items-center  mx-auto'>
        <div>
          <ul
            className={
              inView
                ? `${fade.fadeIn} flex flex-col px-[6rem] text-[1rem] font-bold mt-4 md:flex-row md:space-x-8 md:mt-0`
                : 'flex flex-col px-[6rem] text-[1rem] font-bold mt-4 md:flex-row md:space-x-8 md:mt-0 '
            }>
            <li>
              <a
                href='#'
