...
export const InfoList = [
  {
    ...
    divClass: `box-g absolute right-0 rounded-3xl border-l-[5px] border-l-[#1ed760] border-r-0 border-y-0 box-border h-fit flex flex-col md:flex-row lg:h-[14rem] w-3/4 border-4 lg:justify-between`,
  },
  {
    title: '2',
    ...
    divClass: `box-g absolute left-0 rounded-3xl border-l-[0px] border-r-[5px] border-r-[#1ed760] border-r-0 border-y-0 box-border h-fit flex flex-col md:flex-row lg:h-[14rem] w-3/4 border-4 lg:justify-between mt-[45rem] md:mt-[18rem]`,
  },
  {
    title: '3',
    ...
    divClass: `box-g absolute right-0 rounded-3xl border-l-[5px] border-l-[#1ed760] border-r-0 border-y-0 box-border h-fit flex flex-col md:flex-row lg:h-[14rem] w-3/4 border-4 md:justify-between mt-[90rem] md:mt-[36rem]`,
  },
  {
    title: '4',
    ...
    divClass: `box-g absolute left-0 rounded-3xl border-l-[0px] border-r-[5px] border-r-[#1ed760] border-r-0 border-y-0 box-border h-fit flex flex-col md:flex-row lg:h-[14rem] w-3/4 border-4 lg:justify-between mt-[135rem] md:mt-[54rem]`,
  },
  {
    title: '5',
    ...
    divClass: `box-g absolute right-0 rounded-3xl border-l-[5px] border-l-[#1ed760] border-r-0 border-y-0 box-border h-fit flex flex-col md:flex-row lg:h-[14rem] w-3/4 border-4 md:justify-between mt-[180rem] md:mt-[72rem]`,
  },
];
