...
export function Here({}) {
  return (
    <section className='bg-light bg-[#1ed760] pb-80 h-screen body relative w-full md:w-auto'>
      <Listen className='w-[calc(28vw+(30-28)*((100vw-300px)/(1600-300)))] absolute top-0 right-10 z-[4]' />
      <div className='absolute top-[5rem] lg:top-60 left-5 lg:left-40'>
        <h1 className='h1-calc font-[700] leading-[87.42px] text-[#2941ab]'>
          Listening isn't
        </h1>
      </div>
      <div className='absolute top-[7rem] lg:top-80 left-[4rem] md:left-[6rem] lg:left-[16rem]'>
        <h1 className='h1-calc font-[700] leading-[87.42px] text-[#2941ab]'>
          everything now
        </h1>
      </div>
      <div className='bg-[#1ed760] rounded-l-3xl border-l-[5px] border-l-[#0e173c] border-r-0 border-y-0  absolute bottom-[9rem] lg:left-[15rem] 2xl:bottom-[25rem] lg:bottom-[8rem] xl:left-60 md:left-40 left-[4rem] box-border md:pt-3 lg:pt-0 h-24 w-1/2 pl-2.5  border-4'>
